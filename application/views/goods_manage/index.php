...
<div id="content">
    <div id="left_nav">
        ...
        <details class="menu" open>
            <summary>商品上架</summary>
            <ul>
                <li><a id="add_book">图书上架</a></li>
                <li><a id="add_phone">手机上架</a></li>
                <li><a id="add_computer">电脑上架</a></li>
            </ul>
        </details>
        <details class="menu" open>
                ...
                <div id="add_goods_area">
                    <table>
                        ...
                        <?php foreach($list as $e){
                            ...
                            echo '</td><td><a href="' . site_url('Goods_manage/Deleted_goods/delete?goods_id=' . $e->goods_id) . '">下架</a></a></td>
        </tr>
        ';
                        } ?>
                    </table>
